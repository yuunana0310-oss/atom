...
ROLE_COLORS = {
    "PT": ("#E8EAF6", COLORS["primary"]),   # 薄青 / 濃紺
    "OT": ("#E8F5E9", COLORS["success"]),   # 薄緑 / 濃緑
    "ST": ("#FFF3E0", COLORS["warning"]),   # 薄橙 / 濃橙
    "その他": ("#F3E5F5", "#7B1FA2"),
}
...
class PatientCard(QFrame):
    ...
    def _apply_style(self, hover: bool):
        bg = "#F0F4F8" if hover else "white"
        border = COLORS["accent"] if hover else "#E0E0E0"
        self.setStyleSheet(
...
class UnassignedPanel(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.setStyleSheet(f"UnassignedPanel {{ background:{COLORS['bg_light']}; border-right:1px solid #DDDDDD; }}")
